...
.rl-actions { display: flex; gap: 0.6rem; align-items: flex-start; margin-top: 6px; flex-wrap: wrap; }
...
.rl-alert svg { flex-shrink: 0; margin-top: 1px; }
...
#rolesTable_wrapper .dataTables_length select:focus {
...
table#rolesTable thead tr {
    background: var(--surface-2);
    border-bottom: 2px solid var(--border-strong);
}
table#rolesTable thead th {
...
table#rolesTable thead th.sorting_asc::after,
table#rolesTable thead th.sorting_desc::after { color: var(--accent) !important; }

table#rolesTable tbody tr { transition: background 0.1s; }
table#rolesTable tbody tr:hover { background: #f4f6fd !important; }
table#rolesTable tbody tr:nth-child(odd)  { background: var(--surface); }
table#rolesTable tbody tr:nth-child(even) { background: var(--surface-2); }
table#rolesTable tbody td {
    padding: 0.85rem 1rem !important;
...
table#rolesTable tbody tr:last-child td { border-bottom: none !important; }

/* processing */
#rolesTable_processing {
...
.btn-cancel:hover { background: var(--surface-2); border-color: var(--border-strong); }
...
@media (max-width: 640px) {
    ...
    table#rolesTable thead th,
    table#rolesTable tbody td { padding: 0.7rem 0.7rem !important; }
}
</style>
...
<div class="rl-inner">
    ...
    <div class="rl-header">
        <div>
            <span class="rl-eyebrow">🔐 Akses Sistem</span>
            <h1 class="rl-title">Manajemen Role</h1>
            <p class="rl-subtitle">Kelola role dan permission pengguna sistem</p>
        </div>
        <div class="rl-actions">
            <a href="{{ route('admin.roles.export') }}" class="btn-export">
