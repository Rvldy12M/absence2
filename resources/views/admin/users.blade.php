...
.usr-inner { max-width: 1100px; margin: 0 auto; }
...
.usr-actions { display: flex; gap: 0.6rem; align-items: flex-start; margin-top: 6px; flex-wrap: wrap; }
...
.usr-alert svg { flex-shrink: 0; margin-top: 1px; }
.usr-alert-success {
    background: #f0fdf4;
...
table#usersTable thead th.sorting_asc::after,
table#usersTable thead th.sorting_desc::after { color: var(--accent) !important; }

table#usersTable tbody tr { transition: background 0.1s; }
table#usersTable tbody tr:hover { background: #f4f6fd !important; }
table#usersTable tbody tr:nth-child(odd)  { background: var(--surface); }
table#usersTable tbody tr:nth-child(even) { background: var(--surface-2); }
...
table#usersTable tbody tr:last-child td { border-bottom: none !important; }
...
@media (max-width: 640px) {
    .usr-title { font-size: 1.5rem; }
    table#usersTable thead th,
    table#usersTable tbody td { padding: 0.7rem 0.7rem !important; }
}
</style>
...
<div class="usr-inner">
    ...
    <div class="usr-header">
        <div>
            <span class="usr-eyebrow">👤 Pengguna</span>
            <h1 class="usr-title">Manajemen User</h1>
            <p class="usr-subtitle">Kelola user dengan role admin, dan guru</p>
        </div>
        <div class="usr-actions">
            <a href="{{ route('admin.users.export') }}" class="btn-export">
